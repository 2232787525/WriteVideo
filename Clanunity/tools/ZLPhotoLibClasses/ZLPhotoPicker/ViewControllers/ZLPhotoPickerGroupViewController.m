...
- (UITableView *)tableView{
    if (!_tableView) {
        ...
        [tableView adjustEstimatedHeight];
...
- (void)viewDidLoad {
    ...
    [self.navigationController.navigationBar setBackgroundImage:[UIImage imageWithColor:[UIColor PLColor12B06B_Theme]] forBarMetrics:UIBarMetricsDefault];
...
- (void) setupButtons{
    UIBarButtonItem *barItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"left_back_icon"] style:UIBarButtonItemStylePlain target:self action:@selector(back)];
