...
//   [KZVideoConfig motionBlurView:self];
    ...
    _startBtn.top_sd = _startBtn.top_sd-KBottomStatusH/2.0;
    ...
    NSArray<KZVideoModel *> *videoList =nil;
//    [KZVideoUtil getSortVideoList];
    ...
    _closeVideoBtn.frame = CGRectMake(0,0,40,40);
    _closeVideoBtn.center = CGPointMake(_startBtn.center.x+_startBtn.frame.size.width, _startBtn.center.y);
    CGFloat r = _startBtn.center.x+_startBtn.frame.size.width/2.0;
    CGFloat place = (kzSCREEN_WIDTH - r)/2.0;
    _closeVideoBtn.center = CGPointMake(r+place, _startBtn.center.y);
...
- (void)longpressAction:(UILongPressGestureRecognizer *)gesture {
    ...
    switch (gesture.state) {
        ...
        case UIGestureRecognizerStateEnded: {
            [self endRecordSet];
            if (!_touchIsInside || kzRecordTime - _surplusTime <= 5) {
