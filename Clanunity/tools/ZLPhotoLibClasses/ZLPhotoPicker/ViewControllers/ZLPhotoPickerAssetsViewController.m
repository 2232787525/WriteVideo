...
- (UIButton *)doneBtn{
    if (!_doneBtn) {
        ...
        [rightBtn setTitleColor:[UIColor PLColor12B06B_Theme] forState:UIControlStateNormal];
...
- (void) setupButtons{
   ...
   UIBarButtonItem *backBar = [[UIBarButtonItem alloc] initWithTitle:@"取消" style:UIBarButtonItemStyleDone target:self action:@selector(back)];
    ...
    UIBarButtonItem *leftBar = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"left_back_icon"] style:UIBarButtonItemStylePlain target:self action:@selector(backLastVC)];
