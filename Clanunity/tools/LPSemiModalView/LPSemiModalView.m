    ...
    if (!self.narrowedOff) {
        ...
        [UIView animateWithDuration:0.5f animations:^{
            ...
            self.contentView.frame = CGRectMake(0,
                                                [[UIScreen mainScreen] bounds].size.height - self.contentView.bounds.size.height - KBottomStatusH,
        ...
        [UIView animateWithDuration:0.25f animations:^{
            ...
            [UIView animateWithDuration:0.25f animations:^{
                self.maskImageView.layer.transform = CATransform3DTranslate(t, 0, -30, -30);
            }];
        }];
    } else {
        self.maskImageView.image = [self.class snapshotWithWindow];
